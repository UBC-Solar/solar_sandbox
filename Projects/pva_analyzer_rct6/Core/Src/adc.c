...
void HAL_ADC_ConvHalfCpltCallback(ADC_HandleTypeDef* hadc)
{
    ...
    // HAL_UART_Transmit_DMA(&huart5, (uint8_t *)&adc_buffer[0], sizeof(uint16_t) * NUM_SAMPLES / 2);
}
...
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef* hadc)
{
    ...
    uart_tx_flag = true;
    HAL_GPIO_WritePin(DEBUG1_GPIO_Port, DEBUG1_Pin, 1);       // Debug 1 on when ready to Tx.
}
